...
const CardPromociones = () => {
    return (
        <div className="flex-none w-64 rounded overflow-hidden shadow-lg ml-5">
            <div className='flex justify-between w-full'>
            <img className="w-44 h-48" src={Kerfin} alt="Kerfin" />

            <p className='text-xl pt-16 -rotate-90 font-extrabold transform text-center inline-block'> AUDÍFONOS LOGITECH</p>
            ...
            <div className="px-4 py-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="#FBBF24" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                    ...
                    <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">3.0</span>
                </div>
            </div>
