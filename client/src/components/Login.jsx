...
const Login = () => {
	...
	l2.3-2.3c0.4-0.4,1-0.4,1.4,0c0.4,0.4,0.4,1,0,1.4L13.4,12L15.7,14.3z" fill="#d85b53" className="color000000 svgShape"></path></svg>
                    </button>
                </Link>
            ...
            <Link to="/perfil">
            <button className='w-full rounded-md bg-red-400 text-white uppercase font-semibold text-sm py-2 hover:cursor-pointer mb-8' onClick={handleSubmit} >Continuar</button>
            </Link>
