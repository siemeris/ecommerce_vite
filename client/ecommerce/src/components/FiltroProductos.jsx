  ...
  return (
    <div className='absolute -inset-0 w-2/3 flex justify-evenly flex-col h-full bg-slate-50 p-4 z-30'>
        ...
        <div className="w-full flex justify-between content-center">
            <h3 className="w-4/5 text-start uppercase font-bold m-auto">filtrar por:</h3>
            ...
            categoriasVisible 
                &&
                    <div className='flex flex-col text-center w-full transition-all '>
                            <Link className="list-none hover:cursor-pointer hover:text-indigo-700 text-start ml-5" to={"/productos/computadoras"}>Logitech</Link>
