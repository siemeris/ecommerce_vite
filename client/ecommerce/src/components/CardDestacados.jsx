...
const CardDestacados = () => {
    return (
            <div className="flex flex-row w-11/12 max-w-sm min-h-36 min-w-fit rounded-md bg-white shadow-md mx-auto mb-4 border border-gray-300">
                ...
                <div className="flex flex-col justify-start w-full py-4">
                    <h5 className="text-gray-900 text-2xl font-bold mb-2 w-44 leading-7">Mouse Logitech</h5>

                    <div className="flex">
                        <p className="text-gray-600 text-md font-semibold my-auto pr-2">
                             Bluetooth M350 Rose
                        </p>
                        <Link className='mr-4' >
