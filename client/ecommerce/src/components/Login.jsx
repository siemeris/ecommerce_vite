...
const Login = () => {
	...
	l2.3-2.3c0.4-0.4,1-0.4,1.4,0c0.4,0.4,0.4,1,0,1.4L13.4,12L15.7,14.3z" fill="rgb(109 40 217)" className="color000000 svgShape"></path></svg>
                    </button>
                </Link>
            ...
            <div className='flex w-full justify-between mb-5'>
                <div className="flex items-center my-4">
                    ...
                    <label htmlFor="default-checkbox" className="ml-2 text-sm font-medium text-gray-900">Recuérdame</label>
                </div>
                <p className='text-sm font-medium underline my-4 text-gray-900'>Recuperar contraseña </p>
            </div>

            <Link to="/perfil">
            <button className='w-full rounded-md bg-violet-700 hover:bg-violet-800 text-white uppercase font-semibold text-sm py-2 hover:cursor-pointer mb-8' onClick={handleSubmit} >Continuar</button>
            </Link>
